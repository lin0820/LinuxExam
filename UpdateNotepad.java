...
public class UpdateNotepad extends HttpServlet {
    ...
    final static String URL = "jdbc:mysql://180.76.166.220/LinuxExam";
    final static String USER = "root";
    final static String PASS = "173667Lzl#";
    final static String SQL_INSERT_NOTEPAD = "UPDATE  l_notepad SET notepadName=? WHERE id=?";
    ...
    private int createNotepad(Notepad req) {
        ...
        try {
            ...
            stmt.setString(1, req.notepadName);
